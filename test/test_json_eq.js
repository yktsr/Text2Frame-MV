...
describe('Text2Frame Test', function() {
  var tests = [
    ...
    {title: 'Message / Show Choices/document-sample', infile: "./test/91-show-choices/document-sample.txt", mapfile: "./data/Map001.json", expfile: "./test/91-show-choices/expected_document-sample.json"},
    {title: 'Message / Show Choices/all-args', infile: "./test/91-show-choices/all-args.txt", mapfile: "./data/Map001.json", expfile: "./test/91-show-choices/expected_all-args.json"},
    {title: 'Message / Show Choices/no-args', infile: "./test/91-show-choices/no-args.txt", mapfile: "./data/Map001.json", expfile: "./test/91-show-choices/expected_no-args.json"},
    {title: 'Message / Show Choices/nest', infile: "./test/91-show-choices/nest.txt", mapfile: "./data/Map001.json", expfile: "./test/91-show-choices/expected_nest.json"},
    {title: 'Message / Show Choices/ten-choices', infile: "./test/91-show-choices/ten-choices.txt", mapfile: "./data/Map001.json", expfile: "./test/91-show-choices/expected_ten-choices.json"},
    {title: 'Message / Show Choices/practical-case', infile: "./test/91-show-choices/practical-case.txt", mapfile: "./data/Map001.json", expfile: "./test/91-show-choices/expected_practical-case.json"},
    {title: 'Message / Input Number', infile: "./test/92-input-number.txt", mapfile: "./data/Map001.json", expfile: "./test/expected_92-input-number.json"},
    {title: 'Message / Select Item', infile: "./test/93-select-item.txt", mapfile: "./data/Map001.json", expfile: "./test/expected_93-select-item.json"},
    {title: 'Message / Show Scrolling Text', infile: "./test/94-show-scrolling-text.txt", mapfile: "./data/Map001.json", expfile: "./test/expected_94-show-scrolling-text.json"},
    {title: "Game Progression / Switch", infile: "./test/38-switches.txt", mapfile: "./data/Map001.json", expfile: "./test/38-expected_switches.json"},
    {title: "Game Progression / Control variables/constant", infile: "./test/35-control_variables/constant.txt", mapfile: "./data/Map001.json", expfile: "./test/35-control_variables/expected_constant.json"},
    {title: "Game Progression / Control variables/random", infile: "./test/35-control_variables/random.txt", mapfile: "./data/Map001.json", expfile: "./test/35-control_variables/expected_random.json"},
    {title: "Game Progression / Control variables/gamedata", infile: "./test/35-control_variables/gamedata.txt", mapfile: "./data/Map001.json", expfile: "./test/35-control_variables/expected_gamedata.json"},
    {title: "Game Progression / Control variables/variable", infile: "./test/35-control_variables/variable.txt", mapfile: "./data/Map001.json", expfile: "./test/35-control_variables/expected_variable.json"},
    {title: "Game Progression / Control variables/script", infile: "./test/35-control_variables/script.txt", mapfile: "./data/Map001.json", expfile: "./test/35-control_variables/expected_script.json"},
    {title: "Game Progression / Control variables/misc", infile: "./test/35-control_variables/misc.txt", mapfile: "./data/Map001.json", expfile: "./test/35-control_variables/expected_misc.json"},
    {title: "Game Progression / Control Variables/Last-MZ", infile: "./test/71-control-variables-last-mz.txt", mapfile: "./data/Map001.json", expfile: "./test/71-expected_control-variables-last-mz.json"},
    {title: "Game Progression / Self switch", infile: "./test/39-self_switches.txt", mapfile: "./data/Map001.json", expfile: "./test/39-expected_self_switches.json"},
    {title: "Game Progression / Timer", infile: "./test/40-timer.txt", mapfile: "./data/Map001.json", expfile: "./test/40-expected_timer.json"},
    {title: "Flow Congrol / Conditional Branch/if-else", infile: "./test/50-if-else/if-else.txt", mapfile: "./data/Map001.json", expfile: "./test/50-if-else/expected_if-else.json"},
    {title: "Flow Congrol / Conditional Branch/Switch", infile: "./test/50-if-else/switch.txt", mapfile: "./data/Map001.json", expfile: "./test/50-if-else/expected_switch.json"},
    {title: "Flow Congrol / Conditional Branch/SelfSwitch", infile: "./test/50-if-else/self-switch.txt", mapfile: "./data/Map001.json", expfile: "./test/50-if-else/expected_self-switch.json"},
    {title: "Flow Congrol / Conditional Branch/Variable", infile: "./test/50-if-else/variable.txt", mapfile: "./data/Map001.json", expfile: "./test/50-if-else/expected_variable.json"},
    {title: "Flow Congrol / Conditional Branch/Timer", infile: "./test/50-if-else/timer.txt", mapfile: "./data/Map001.json", expfile: "./test/50-if-else/expected_timer.json"},
    {title: "Flow Congrol / Conditional Branch/Actor", infile: "./test/50-if-else/actor.txt", mapfile: "./data/Map001.json", expfile: "./test/50-if-else/expected_actor.json"},
    {title: "Flow Congrol / Conditional Branch/Enemy", infile: "./test/50-if-else/enemy.txt", mapfile: "./data/Map001.json", expfile: "./test/50-if-else/expected_enemy.json"},
    {title: "Flow Congrol / Conditional Branch/Character", infile: "./test/50-if-else/character.txt", mapfile: "./data/Map001.json", expfile: "./test/50-if-else/expected_character.json"},
    {title: "Flow Congrol / Conditional Branch/Vehicle", infile: "./test/50-if-else/vehicle.txt", mapfile: "./data/Map001.json", expfile: "./test/50-if-else/expected_vehicle.json"},
    {title: "Flow Congrol / Conditional Branch/Gold", infile: "./test/50-if-else/gold.txt", mapfile: "./data/Map001.json", expfile: "./test/50-if-else/expected_gold.json"},
    {title: "Flow Congrol / Conditional Branch/Item", infile: "./test/50-if-else/item.txt", mapfile: "./data/Map001.json", expfile: "./test/50-if-else/expected_item.json"},
    {title: "Flow Congrol / Conditional Branch/Weapon", infile: "./test/50-if-else/weapon.txt", mapfile: "./data/Map001.json", expfile: "./test/50-if-else/expected_weapon.json"},
    {title: "Flow Congrol / Conditional Branch/Armor", infile: "./test/50-if-else/armor.txt", mapfile: "./data/Map001.json", expfile: "./test/50-if-else/expected_armor.json"},
    {title: "Flow Congrol / Conditional Branch/Button", infile: "./test/50-if-else/button.txt", mapfile: "./data/Map001.json", expfile: "./test/50-if-else/expected_button.json"},
    {title: "Flow Congrol / Conditional Branch/Script", infile: "./test/50-if-else/script.txt", mapfile: "./data/Map001.json", expfile: "./test/50-if-else/expected_script.json"},
    {title: "Flow Congrol / Conditional Branch/Error", infile: "./test/50-if-else/error.txt", mapfile: "./data/Map001.json", expfile: "./test/50-if-else/expected_error.json"},
    {title: "Flow Control / Conditional Branch/Button-MZ", infile: "./test/70-if-else-button-mz.txt", mapfile: "./data/Map001.json", expfile: "./test/70-expected_if-else-button-mz.json"},
    {title: "Flow Control / Loop", infile: "./test/51-loop.txt", mapfile: "./data/Map001.json", expfile: "./test/51-expected_loop.json"},
    {title: "Flow Control / Break Loop", infile: "./test/52-break-loop.txt", mapfile: "./data/Map001.json", expfile: "./test/52-expected_break-loop.json"},
    {title: "Flow Control / Exit Event Processing", infile: "./test/53-exit-event-processing.txt", mapfile: "./data/Map001.json", expfile: "./test/53-expected_exit-event-processing.json"},
    {title: "Flow Control / Label", infile: "./test/54-label.txt", mapfile: "./data/Map001.json", expfile: "./test/54-expected_label.json"},
    {title: "Flow Control / Jump to Label", infile: "./test/55-jump-to-label.txt", mapfile: "./data/Map001.json", expfile: "./test/55-expected_jump-to-label.json"},
    ...
    {title: "Actor / Change Skill", infile: "./test/actor/change-skill.txt", mapfile: "./data/Map001.json", expfile: "./test/actor/expected_change-skill.json"},
    ...
    {title: "Picture / Show Picture", infile: "./test/56-show-picture.txt", mapfile: "./data/Map001.json", expfile: "./test/56-expected_show-picture.json"},
    {title: "Picture / Move Picture", infile: "./test/57-move-picture.txt", mapfile: "./data/Map001.json", expfile: "./test/57-expected_move-picture.json"},
    {title: "Picture / Move Picture MZ", infile: "./test/69-move-picture-mz.txt", mapfile: "./data/Map001.json", expfile: "./test/69-expected_move-picture-mz.json"},
    {title: "Picture / Rotate Picture", infile: "./test/58-rotate-picture.txt", mapfile: "./data/Map001.json", expfile: "./test/58-expected_rotate_picture.json"},
    {title: "Picture / Tint Picture", infile: "./test/59-tint-picture.txt", mapfile: "./data/Map001.json", expfile: "./test/59-expected_tint-picture.json"},
    {title: "Picture / Erase Picture", infile: "./test/60-erase-picture.txt", mapfile: "./data/Map001.json", expfile: "./test/60-expected_erase-picture.json"}, 
