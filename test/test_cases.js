const tests = [
  ...
  {title: "Diff / Add block", infile: "./test/diff/add-block.txt", mapfile: "./test/diff/add-block-map.json", expfile: "./test/diff/expected_add-block.json"},
  {title: "Diff / Modify block", infile: "./test/diff/modify-block.txt", mapfile: "./test/diff/modify-block-map.json", expfile: "./test/diff/expected_modify-block.json"},
  {title: "Diff / Remove block", infile: "./test/diff/remove-block.txt", mapfile: "./test/diff/remove-block-map.json", expfile: "./test/diff/expected_remove-block.json"},
  {title: "Diff / No change", infile: "./test/diff/no-change.txt", mapfile: "./test/diff/no-change-map.json", expfile: "./test/diff/expected_no-change.json"},
  {title: "Diff / Empty existing", infile: "./test/diff/empty-existing.txt", mapfile: "./test/diff/empty-existing-map.json", expfile: "./test/diff/expected_empty-existing.json"},
