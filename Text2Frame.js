 ...
 *  基本的にはデフォルト設定で問題がありませんが、最初だけは、
 *  "テキストのフォルダ名"だけは新規のフォルダ名を設定したほうが良いかも
 *  しれません。実行時に、ゲーム内のすべてのイベントがフォルダ内にエクスポートさ
 *  れるためです。
 *
 ...
 *
 *  最初だけは、第2引数だけは新規のフォルダ名に変更したほうが良いかもしれません。
 *  実行時に、ゲーム内のすべてのイベントがフォルダ内にエクスポートされるためです。
 *
