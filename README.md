...
|&lt;BGSの演奏 : Battle2, 90, 100, 0>|&lt;PlayBGM : City, 90, 100, 0>|BGSの再生イベントを挿入する。引数は順に、曲名、音量90、ピッチ100、位相0で組み込まれる。音量、ピッチ、位相は省略できる|
|&lt;BGSのフェードアウト : 20>|&lt;FadeoutBGM : 20>|BGMのフェードアウトイベントを挿入する。引数はフェードアウトする秒数である。引数は省略できる|
